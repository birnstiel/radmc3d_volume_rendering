#SRC = .
SRC=~/CODES/radmc-3d/radmc-3d/version_0.41/src/
...
IMODULES       = $(HMODULES) amrray_module.o dust_module.o stars_module.o
...
stars_module.o:     $(SRCSTARS) $(GMODULES) Makefile
...
sources_module.o:   $(SRCSOURCES) $(GMODULES) Makefile
